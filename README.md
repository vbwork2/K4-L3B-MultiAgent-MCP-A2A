...
Từ thư mục repo, tạo môi trường Python 3.11+ và cài gói một lần:
...
Điền `COMPETITION_TEAM_API_KEY` và `MCP_ENDPOINT` thật trong `.env`, đặt `case-set.json` và đủ 100 file JSON trong `inputs\`. Sau đó chạy:
